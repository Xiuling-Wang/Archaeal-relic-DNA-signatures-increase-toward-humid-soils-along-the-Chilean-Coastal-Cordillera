...
#   summarise(across(everything(), mean, na.rm = TRUE)) %>% #什么鬼，原来能运行，更新后就不行啦。shit
...
env.idna.av <- env_tmp %>%
  group_by(site_dna_depth) %>%
  summarise(across(c(depth, pH:N, C, CN:Sio, NH4:Mnp), ~ mean(.x, na.rm = TRUE)), .groups = "drop") %>%
  column_to_rownames(var = "site_dna_depth")
...
env <- env.idna.av
tax <- tax.idna
filt = colMeans(asv) > 0.02
asv <- asv[,filt]# Remove ASVs mean abundance < 0.02%
...
write.csv(asv, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/relative_abundance_filtered.csv")
...
traitColors = numbers2colors(env, 
                             signed = FALSE)
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/simple_dendrogram_trait_heatmap.pdf",
    width = pdf_width, 
    height = pdf_height)
...
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/PCA_ASV.pdf",
    width = pdf_width, 
    height = pdf_height)
...
p2 <- ggplot(sft.data, aes(Power, mean.k., label = Power)) +
  ...
  theme_classic()
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/R2_connectivity.pdf",
    width = pdf_width, 
    height = pdf_height)
grid.arrange(p1, p2, nrow = 2)
dev.off()
# Network construction and module detection
soft_power <- 5  # picked from the graph above (high R² and low connectivity)
...
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/dendrogram_modules.pdf",
    width = pdf_width,
...
table(module_colors)# 10 modules
...
write.csv(network_features, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/Table_net.csv")
...
num_colors
colors <- colorRampPalette(brewer.pal(5, "Paired"))(num_colors)
# Create a color dictionary with class-color mappings
color_dict <- setNames(colors, unique_phyla)

write.csv(node.topology, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/Table_node.csv")
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/Keystone_Species.pdf",
    width = pdf_width,
    height = pdf_height)
...
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/co-ocurrence network.pdf",
    width = pdf_width,
    height = pdf_height)
# set.seed(101)#
# set.seed(103)
...
if (print_flag) {
  ...
  write.csv(module.trait.corr, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/Module_trait_r.csv")
  write.csv(module.trait.corr.pvals, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/Module_trait_p-value.csv")
}
...
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/environment_modules_heatmap.pdf",
    width = pdf_width+10, 
    height = pdf_height)
...
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/sites_modules_heatmap.pdf",
    width = pdf_width-3, 
    height = pdf_height-3)
...
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/depth_modules_heatmap.pdf",
    width = pdf_width-2, 
    height = pdf_height-2)
...
write.csv(module.asv.mapping, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/ASV_module.csv")
# ASV - Modules - taxa
...
write.csv(sorted_data, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/ASV_module_taxa.csv")
# ASV - rel. ab. - Modules
...
write.csv(combined_df, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/ASV_module_relative_abu_taxa.csv")
...
writeLines(output_lines, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/Modules_overview.txt")
...
write.csv(TopHub_ASV, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/ASV_top_hub.csv")
...
#rename rownames (remove "iDNA") and save relative abundance to CSV file
rownames(asv) <- sub("iDNA", "_", rownames(asv)) #replace iDNA with _
write.csv(asv, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_relative_abundance_filtered.csv")
rownames(env) <- sub("iDNA", "_", rownames(env))
rownames(Site) <- sub("iDNA", "_", rownames(Site))
rownames(Depth) <- sub("iDNA", "_", rownames(Depth))
# WGCNA analysis ----------------------------------------------------------
...
traitColors = numbers2colors(env, 
                             signed = FALSE)
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_simple_dendrogram_trait_heatmap.pdf",
    width = pdf_width, 
    height = pdf_height)
...
pca.var.percent <- round(pca.var/sum(pca.var)*100, 
                         digits = 2)
pca.dat <- as.data.frame(pca.dat)
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_PCA_ASV.pdf",
    width = pdf_width, 
    height = pdf_height)
...
p2 <- ggplot(sft.data, aes(Power, mean.k., label = Power)) +
  ...
  labs(x = 'Power', y = 'Mean Connectivity') +
  theme_classic()
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_R2_connectivity.pdf",
    width = pdf_width, 
    height = pdf_height)
grid.arrange(p1, p2, nrow = 2)
dev.off()
# Network construction and module detection
soft_power <- 8  # picked from the graph above (high R² and low connectivity)
# co-occurrence network base on WGCNA (changed by Xiuling)-------------------------------------
temp_cor <- cor
cor <- WGCNA::cor
bwnet <- blockwiseModules(asv,
...
#grey module = others gene
# Plot the dendrogram and the module colors before and after merging underneath
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_dendrogram_modules.pdf",
    width = pdf_width,
    height = pdf_height * 2)#double height to add the legend
...
write.csv(network_features, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_Table_net.csv")
...
num_colors <- length(unique_phyla)
num_colors
colors <- colorRampPalette(brewer.pal(4, "Set1"))(num_colors)
# Create a color dictionary with class-color mappings
color_dict <- setNames(colors, unique_phyla)

write.csv(node.topology, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_Table_node.csv")
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_Keystone_Species.pdf",
    width = pdf_width,
    height = pdf_height)
...
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_co-ocurrence network.pdf",
    width = pdf_width,
    height = pdf_height)
#set.seed(101)#
#set.seed(102)
...
if (print_flag) {
  module.trait.corr <- cor(module_eigengenes, env, 
                           use = 'p')
  module.trait.corr.pvals <- corPvalueStudent(module.trait.corr, nrow(asv))
  write.csv(module.trait.corr, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_Module_trait_r.csv")
  write.csv(module.trait.corr.pvals, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_Module_trait_p-value.csv")
}
...
nMod <- length(module_eigengenes)-1
nEnd <- length(colnames(heatmap.data))
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_environment_modules_heatmap.pdf",
    width = pdf_width+10, 
    height = pdf_height)
...
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_sites_modules_heatmap.pdf",
    width = pdf_width-3, 
    height = pdf_height-3)
...
pdf("/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_depth_modules_heatmap.pdf",
    width = pdf_width-2, 
    height = pdf_height-2)
...
# ASV - Modules
module.asv.mapping <- as.data.frame(bwnet$colors)
write.csv(module.asv.mapping, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_ASV_module.csv")
# ASV - Modules - taxa
tax_order <- match(rownames(module.asv.mapping),rownames(tax))
tax.idna.order <- tax[tax_order,]
data <- cbind(module.asv.mapping, tax.idna.order)
...
sorted_data <- data[order(data[, 1], data[, 2], data[, 3],
                          data[, 4], data[, 5], data[, 6], data[, 7]), ]
write.csv(sorted_data, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_ASV_module_taxa.csv")
# ASV - rel. ab. - Modules
asv_t <- as.data.frame(t(asv))
asv_order <- match(rownames(module.asv.mapping),rownames(asv_t))
asv.mod <- asv_t[asv_order,]
combined_df <- cbind(module.asv.mapping, tax.idna.order,asv.mod)
write.csv(combined_df, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_ASV_module_relative_abu_taxa.csv")
...
output_lines <- c("Modules:",
                  ...
                  paste(rownames(as.data.frame(hub_output)),hub_output, sep = ": "))
# Save the combined output to a text file
writeLines(output_lines, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_Modules_overview.txt")

# 3) Top hub in each module with taxa
ASV_rows <- match(hub_output,rownames(tax))
TopHub_ASV <- tax[ASV_rows, ]
TopHub_ASV$Module <- rownames(as.data.frame(hub_output))
write.csv(TopHub_ASV, "/Users/xwang/Library/Mobile Documents/com~apple~CloudDocs/001 👩🏻‍🎓PhD Project/phd_es16s/data/02 🌼Chile Archaea/netdata/eDNA_ASV_top_hub.csv")
# Example of how to show a certain module
module.asv.mapping %>% 
  filter(`bwnet$colors` == 'turquoise') %>% 
  rownames()
